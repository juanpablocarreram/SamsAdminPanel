    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* .sam-navbar::before {
            ...
            display: block;
            height: 3px;
            background: linear-gradient(90deg, var(--sam-yellow) 0%, #FFD966 50%, var(--sam-yellow) 100%);
        } */
        .sam-navbar-inner {
            display: flex;
            align-items: stretch;
        ...
        .sam-brand-logo {
            width:5vw;
            object-fit: contain;
            filter: drop-shadow(0 2px 6px rgba(0,0,0,.5)) brightness(1.1);
        }
        .sam-brand-text {
            display: flex;
        ...
        .sam-nav-tabs .nav-link .nav-icon {
            font-size: 1rem;
            opacity: .7;
            transition: opacity .2s;
        }
        .sam-nav-tabs .nav-link:hover {
            color: #fff !important;
            background: rgba(255,255,255,.07);
        }
        .sam-nav-tabs .nav-link:hover .nav-icon { opacity: 1; }
        .sam-nav-tabs .nav-link.active {
            color: #fff !important;
            border-bottom-color: var(--sam-yellow);
            background: rgba(255,255,255,.06);
        }
        .sam-nav-tabs .nav-link.active .nav-icon { opacity: 1; }
        ...
        .stat-card {
            ...
            border-left: 5px solid var(--sam-blue);
        ...
        /* Badge de descuento aplicado en el carrito */
        ...
        .form-label { 
            ...
            font-weight: 600; color: var(--sam-dark); display: block;
        }
        .form-control, .form-select { 
            font-size: 0.95rem; padding: 10px 13px;
            border: 1.5px solid var(--sam-border); border-radius: 8px;
            background: var(--sam-card); color: #374151;
        ...
        .section-title { 
            font-weight: 800; color: var(--sam-dark); font-size: 1rem; 
            margin-bottom: 12px; padding-bottom: 8px; 
            border-bottom: 3px solid var(--sam-yellow);
            display: block;
        }
        ...
        /* ── POS PANEL ── */
        .pos-panel { 
            background: var(--sam-card); border-radius: 12px; 
            box-shadow: 0 1px 3px rgba(0,0,0,.08); border: 1px solid var(--sam-border);
            height: calc(100vh - 160px); display: flex; flex-direction: column; overflow: hidden;
        }
        .pos-panel-header { 
            background: linear-gradient(135deg, var(--sam-blue) 0%, #002E85 100%);
        ...
        #searchResults, #socioResults { 
            ...
            background: var(--sam-card); border: 1px solid var(--sam-border);
            border-top: none; border-radius: 0 0 8px 8px; 
            max-height: 300px; overflow-y: auto;
            box-shadow: 0 8px 16px rgba(0,0,0,.12);
        }
        #searchResults .res-item, #socioResults > div { 
            padding: 12px 14px; cursor: pointer; border-bottom: 1px solid var(--sam-border);
        ...
        /* Badge de membresía requerida en el autocomplete */
        .res-memb-tag { font-size: .72rem; font-weight: 700; padding: 2px 6px; border-radius: 5px; 
                        background: #EFF6FF; color: var(--sam-blue); border: 1px solid #BFDBFE; }
        ...
        /* Tipo membresía badge dentro del socio-block */
        ...
        /* ── COMPRAS: form card sin altura máxima para que la tabla crezca ── */
        #panel-compras .sam-form-card {
            max-height: none;
            overflow-y: visible;
        }
    </style>
...
<nav class="sam-navbar">
    <div class="sam-navbar-inner container-fluid px-0">
        ...
        <div class="sam-brand">
            ...
            <!-- <div class="sam-brand-text">
                <span class="sam-brand-title">Sam's <em>Club</em></span>
                <span class="sam-brand-sub">Panel de Gestión</span>
            </div> -->
        </div>
        ...
        <ul class="nav sam-nav-tabs" id="mainTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="tab-inv" data-bs-toggle="tab" href="#panel-inventario" role="tab">
                    Inventario
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab-promo" data-bs-toggle="tab" href="#panel-promos" role="tab">
                    Promociones
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab-comp" data-bs-toggle="tab" href="#panel-compras" role="tab">
                    Compras
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tab-vta" data-bs-toggle="tab" href="#panel-ventas" role="tab">
                    Punto de Venta
                </a>
            </li>
        </ul>
        ...
        <div style="flex: 0 0 40%; min-width: 0;">
            <div class="sam-form-card">
                ...
                <div class="mb-3">
                    ...
                    <select id="promoProducto" class="form-select">
                        <option value="">Cargando…</option>
                    </select>
                </div>
                <div class="mb-3">
                    <label class="form-label">Nombre de la promoción</label>
                    <input type="text" id="promoNombre" class="form-control" placeholder="Ej: 2x1 Verano">
                </div>
                <div class="mb-3">
                ...
                <!-- ── NUEVA SECCIÓN: ELEGIBILIDAD POR MEMBRESÍA ── -->
                <div class="mb-3">
                    ...
                    <div id="membresiaChecks" class="membresia-checks">
                ...
                <button class="btn btn-primary w-100 fw-bold mt-2" onclick="crearPromo()">
                    ✅ Registrar Promoción
                </button>
            </div>
        </div>
        ...
        <div style="flex: 1; min-width: 0;">
            <div class="sam-form-card">
                ...
                <div class="mb-3">
                    ...
                    <select id="compraZona" class="form-select">
                ...
                <div style="margin-bottom: 12px; border-radius: 8px; border: 1px solid var(--sam-border); overflow: hidden;">
                    <table class="table table-sm mb-0 compra-items-table">
                        ...
                        <tbody id="compraItemsBody">
                            <tr id="compraEmptyRow">
                                <td colspan="5" class="text-center text-muted py-3">Sin productos agregados</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <button class="btn btn-primary w-100 fw-bold" onclick="procesarCompra()">
                    ✅ Registrar Compra
                </button>
            </div>
        </div>
        ...
        <div style="flex: 0 0 34%; min-width: 0;">
            <div class="pos-panel">
                ...
                <div class="pos-panel-footer">
                    ...
                    <button class="btn btn-success w-100 fw-bold" style="padding: 12px;" onclick="procesarVenta()">
                        ✅ Cobrar
                    </button>
                </div>
            </div>
...
function renderMembresiaChecks() {
    ...
    const todosCheck = document.getElementById('promoAplicaTodos');
    container.innerHTML = tiposMembresia.map(tm => {
        const cls = tm.nombre; // CLASICA, BENEFITS, PLUS
...
function toggleMembCheck(id, nombre, color) {
    ...
    if (chk.checked) {
        lbl.classList.add(`checked-${nombre}`);
        lbl.style.borderColor = color;
    } else {
        lbl.classList.remove(`checked-${nombre}`);
        lbl.style.borderColor = `${color}20`;
    }
}
...
async function loadPromos() {
    ...
    res.data.forEach(r => {
        ...
        if (r.aplica_a_todos == '1') {
            membTag = '<span class="badge bg-dark">Todos</span>';
        } else if (r.membresias_aplicables) {
            membTag = r.membresias_aplicables.split(', ').map(m => {
                const colorMap = { CLASICA: 'secondary', BENEFITS: 'primary', PLUS: 'purple' };
                const styleMap = { CLASICA: 'bg-secondary', BENEFITS: 'bg-primary', PLUS: '' };
                const style = m === 'PLUS' ? 'background:#7C3AED;' : '';
                return `<span class="badge" style="font-size:.7rem;${style}">${m}</span>`;
            }).join(' ');
        } else {
            membTag = '<span class="text-muted small">—</span>';
        }
        body.innerHTML += `<tr>
            ...
            <td>${badge}</td>
            <td>
                <button class="btn btn-outline-warning btn-sm me-1" onclick="togglePromo(${r.id})">
...
async function crearPromo() {
    ...
    const pct     = document.getElementById('promoDescPct').value;
    const monto   = document.getElementById('promoDescMonto').value;
    ...
    if (aplicaTodos === '0' && tiposSeleccionados.length === 0) {
        toast('Selecciona al menos un tipo de membresía o marca "Aplica a todos"','error');
        return;
    }
    ...
    const res = await api('promociones.php', {
        ...
        fecha_inicio: fi,
        fecha_fin: ff,
        aplica_a_todos: aplicaTodos,
        tipos_membresia_ids: JSON.stringify(tiposSeleccionados)
    });
    if (res.success) {
        toast(res.message);
        // Reset form
        document.getElementById('promoNombre').value = '';
        document.getElementById('promoDescPct').value = '';
        document.getElementById('promoDescMonto').value = '';
        document.getElementById('promoFechaIni').value = '';
...
function agregarItemCompra() {
    ...
    if (existing) {
        ...
        existing.precio_costo = precio || existing.precio_costo;
        toast(`Cantidad actualizada para ${nombre}`);
    } else {
        compraItems.push({ producto_id: prod_id, nombre, sku, cantidad: cant, precio_costo: precio });
    }
    renderCompraItems();
...
function renderCompraItems() {
    ...
    body.innerHTML = compraItems.map((it, i) => {
        ...
        return `<tr class="compra-item-row">
            ...
            <td class="text-center"><input type="number" value="${it.cantidad}" min="1" step="1" style="width:75px;"
                   onchange="updateCompraItem(${i},'cantidad',this.value)" oninput="updateCompraItem(${i},'cantidad',this.value)"></td>
            <td class="text-center"><input type="number" value="${it.precio_costo || ''}" min="0" step="0.01"
                   placeholder="0.00" style="width:90px;"
                   onchange="updateCompraItem(${i},'precio_costo',this.value)" oninput="updateCompraItem(${i},'precio_costo',this.value)"></td>
...
async function procesarCompra() {
    ...
    const res = await api('compras.php', {
        action: 'registrar', proveedor_id: prov_id, zona_id, es_reserva: es_res,
...
// ── CALCULAR MEJOR DESCUENTO para un producto dado el socio actual ──
// Devuelve { descuento, promo_id, tipo_descuento, promo_nombre, memb_requerida, aplico }
function calcularMejorDescuento(producto) {
    ...
    if (!elegibles.length) {
        ...
        return { descuento: 0, promo_id: null, tipo_descuento: 'NINGUNO', promo_nombre: null, aplico: false,
                 promo_bloqueada: todasPromos,
                 memb_requerida: promos.map(p => p.tipos_nombres || 'N/A').join('; ') };
    }

    // Elegir la de mayor descuento (en valor absoluto sobre precio unitario)
    ...
    const descuento = parseFloat(mejorValor.toFixed(2));
    return {
        descuento,
...
// Recalcular descuentos de todos los items al cambiar de socio
...
async function buscarProductoPos() {
    ...
    searchProductoTimer = setTimeout(async () => {
        ...
        if (!res.success || !res.data.length) {
            container.innerHTML = '<div class="res-item text-muted">Sin resultados</div>';
            return;
        }
        res.data.forEach(p => {
            ...
            // Calcular si hay promos y si aplican al socio actual
            ...
            if (promos.length) {
                ...
                if (resultado.aplico) {
                    ...
                    const membReq = resultado.memb_requerida || '?';
                    promoTag = ` <span class="res-memb-tag" title="Requiere: ${membReq}">🔒 ${resultado.promo_bloqueada}</span>`;
                }
            }
...
function addToCart(p) {
    ...
    if (existing) {
        ...
        cart.push({
            ...
            promo_nombre: resultado.promo_nombre,
            _desc_info:   resultado,
            _producto_raw: p,   // guardar referencia para recalcular
            stock_max:    parseFloat(p.stock)
        });

        // Avisar si hay promo pero no aplica
...
function renderCart() {
    ...
    body.innerHTML = cart.map((it, idx) => {
        ...
        let descTag = '—';
        if (desc > 0) {
            descTag = `<span class="badge-desc-ok">−${fmt(desc)} ✓</span>`;
        } else if (it._desc_info?.promo_bloqueada) {
            descTag = `<span class="badge-desc-no" title="Requiere: ${it._desc_info.memb_requerida}">🔒 Sin desc.</span>`;
        }
        ...
        return `<tr>
            ...
            <td class="text-center">
                <div class="input-group input-group-sm" style="width:100px">
                    ...
                    <input type="number" class="form-control text-center" value="${it.cantidad}" min="1"
                           onchange="setQty(${idx},this.value)" style="width:45px">
                    <button class="btn btn-outline-secondary" onclick="changeQty(${idx},1)">+</button>
                </div>
            </td>
...
// ── BUSCAR SOCIO (devuelve socio_membresia_id y tipo) ──
let socioTimer;
async function buscarSocio() {
    ...
    socioTimer = setTimeout(async () => {
        ...
        res.data.forEach(s => {
            ...
            d.onclick = () => {
                selectedSocio = s; // { socio_id, nombre, socio_membresia_id, tipo_membresia_id, membresia, ... }
                // Actualizar UI del bloque socio
                ...
                document.getElementById('socioMembInfo').textContent =
                    `Cashback acumulado: ${fmt(s.saldo_cashback)} · Vence: ${s.fecha_fin || '—'}`;
                ...
                // Recalcular descuentos del carrito con la nueva membresía
...
function quitarSocio() {
    ...
    document.getElementById('socioInputWrap').style.display = '';
    document.getElementById('posSearchSocio').value = '';
    // Limpiar datos del socio anterior
    ...
    document.getElementById('socioMembInfo').textContent = '';
    // Recalcular sin membresía (elimina descuentos de membresía)
    recalcularDescuentosCarrito();
}
...
async function procesarVenta() {
    ...
    if (diferencia < -0.009) {
        toast(`Pago insuficiente. Faltan ${fmt(Math.abs(diferencia))} para cubrir el total de ${fmt(totalCarrito)}`, 'error');
        return;
    }
    ...
    const res = await api('ventas.php', {
        ...
        items: JSON.stringify(cart.map(i => ({
            ...
            cantidad:       i.cantidad,
            precio:         i.precio,
            descuento:      i.descuento * i.cantidad, // descuento total del renglón
            promo_id:       i.promo_id,
            tipo_descuento: i.tipo_descuento
        }))),
