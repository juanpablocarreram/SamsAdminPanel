    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sam-navbar .brand {
            ...
            letter-spacing: .5px; padding: 12px 20px;
            display: flex; align-items: center; gap: 10px;
        }
        .sam-navbar .brand span { color: var(--sam-yellow); }
        .sam-nav-tabs { border: none; margin: 0; padding: 0 10px; }
        ...
        .sam-nav-tabs .nav-link:hover { color: #fff !important; background: rgba(255,255,255,.08); }
        .sam-nav-tabs .nav-link.active {
            color: var(--sam-yellow) !important;
            border-bottom-color: var(--sam-yellow);
            background: rgba(255,255,255,.05);
        }
        .sam-nav-tabs .nav-link i { margin-right: 6px; }
...
<nav class="sam-navbar">
    <div class="container-fluid d-flex align-items-stretch flex-wrap p-0">
        <div class="brand">
            <img src="img/sams_logo.png" alt="Logo" style="width: 100px; height: 100px; object-fit: contain; filter: drop-shadow(0 4px 8px rgba(0, 0, 0, 0.6));">
            <span>SAM'S CLUB</span> <span style="color:rgba(255,255,255,.6);font-weight:400;font-size:.9rem">· Panel de Gestión</span>
        </div>
        <ul class="nav sam-nav-tabs ms-auto" id="mainTab" role="tablist">
            <li class="nav-item">
...
<div class="tab-pane fade" id="panel-compras" role="tabpanel">
    <div style="display: flex; gap: 20px; height: 100%;">
        <div style="flex: 1; min-width: 0; display: flex; flex-direction: column;">
            <div class="sam-form-card" style="flex: 1; display: flex; flex-direction: column;">
                ...
                <div style="flex: 1; overflow-y: auto; margin-bottom: 12px; border-radius: 8px; border: 1px solid var(--sam-border);">
